...
export class AdminPageComponent {
  ...
  deleteUser(email: string) {
    this.http.delete(`${this.userService.baseUrl}/admin/deleteUser/${email}`, 
    { headers: { "Authorization": "Bearer " + this.tokenService.getToken() }, responseType: "text" }).subscribe(error => {
